@extends('layouts.master')
 @section('content') 
 @section('title', 'Manage Videogallery ')
<div class="card">
    <div class="card-body">
        <div id="page-wrapper">
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="search-from mb-3">
                                ...
                                <form action="{{ url('/admin/videogallery')}}" class="search_inbox" name="form1" id="form1" method="post" accept-charset="utf-8">
                                    @csrf
                                    <div class="form-row">
