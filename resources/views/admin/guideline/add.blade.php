        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body"> 
                    ...
                    <form  action="{{URL::to('admin/guidelines/')}}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        @csrf
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <input name="menu_title" minlength="2" maxlength="255" onkeypress="return onlyAlphabets(event,this);" autocomplete="off" type="text" class="input_class form-control  @error('menu_title') is-invalid @enderror" id="txtename"   value="{{old('menu_title')}}"  />
                                        @error('menu_title')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <input type="file" name="txtuplode" accept=".pdf" class="input_class  form-control @error('txtuplode') is-invalid @enderror  inline-block" id="txtuplode" />
