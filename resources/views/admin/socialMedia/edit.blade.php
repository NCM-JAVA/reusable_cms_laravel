                ...
                @csrf
					...
					<div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                               <div class="form-group">
                                    <input name="page_url" maxlength="255"
                                    minlength="2"  autocomplete="off" type="text" 
                                    class="input_class form-control  @error('page_url') is-invalid @enderror" id="page_url" value="{{ !empty($data->page_url)?$data->page_url:old('page_url')}}"  />
                                    @error('page_url')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
