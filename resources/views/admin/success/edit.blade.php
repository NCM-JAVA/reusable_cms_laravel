...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card-body"> 
                ...
                <form  action="{{ route('success.update' , $data->id) }}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
                    @method('PUT')
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <input name="page_url" onkeypress="return onlyAlphabets(event,this);"  autocomplete="off" type="text"
                                    minlength="2" 
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="input_class form-group">
                                    ...
                                    <select name="storytype" id="storytype" class="form-control @error('storytype') is-invalid @enderror" autocomplete="off" >
                                    <option value="">Select</option>
                                        <?php 
                                        ...
                                        {
                                        ?>
                                        <option value="{{$key}}"  @if((!empty($data->storytype)?$data->storytype:old('storytype'))==$key) selected @endif ><?php echo $value; ?></option>
                                        <?php 
                                        }
                                        ?>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xm-12">
                                <div class="pull-right">
                                    ...
                                    <a href="{{URL::to('admin/success/')}}" class="btn btn-primary" >back</a>
                                </div>
                            </div>
                        </div>
                    </div>
