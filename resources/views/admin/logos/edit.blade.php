            ...
            <div class="card-body"> 
                ...
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                <select name="txttype" class="input_class form-control" id="txttype" autocomplete="off">
                                    <option value=""> Select Type </option>
                                    <option value="1" {{ (old('txttype', $data->txttype ?? '') == '1') ? 'selected' : '' }}>Logo</option>
                                    <option value="2" {{ (old('txttype', $data->txttype ?? '') == '2') ? 'selected' : '' }}>Important Link</option>
                                </select>
