                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="input_class form-group">
                                    ...
                                    <option value="">Select</option>
                                        <?php 
                                        $menuTypeArray = array("2"=>"PDF file Upload","3"=>"Url");
                        ...
                        <div class="row">
									...
									<div class="col-lg-6 col-md-6 col-xm-6">
										<div class="form-group">
											...
											<input type="date" name="startdate" class="input_class form-control" autocomplete="off" value="{{!empty($data->start_date)?$data->start_date:old('startdate')}}">
                                        </div>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-xm-6">
										<div class="form-group">
											...
											<input type="date" name="enddate" class="input_class form-control" autocomplete="off" value="{{!empty($data->end_date)?$data->end_date:old('enddate')}}">
                                        </div>
