                    ...
                    <div class="panel-body">
                        ...
                        <div id="txtDoc" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <textarea name="description" onkeypress="return onlyAlphabets(event,this);" id="editor" class="form-control  @error('description') is-invalid @enderror " rows="3" aria-hidden="true" ><?php echo old('description'); ?></textarea>
                        ...
                        <div class="row">
									...
									<div class="col-lg-6 col-md-6 col-xm-6">
										<div class="form-group">
											...
											<input type="date" name="startdate" class="input_class form-control  @error('startdate') is-invalid @enderror" autocomplete="off" value="{{old('startdate')}}">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-xm-6">
										<div class="form-group">
											...
											<input type="date" name="enddate" class="input_class form-control  @error('enddate') is-invalid @enderror " autocomplete="off"value="{{old('enddate')}}">
