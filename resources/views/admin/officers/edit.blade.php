                ...
                @csrf
					...
					<div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <textarea name="contents" autocomplete="off" class="input_class form-control @error('contents') is-invalid @enderror  summernote-simple">{{!empty($data->contents)?$data->contents:old('contents')}}</textarea>
                                    @error('contents')
                                    <span class="invalid-feedback" role="alert">
