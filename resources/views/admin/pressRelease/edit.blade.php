    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card-body"> 
                    ...
                    <form action="{{ route('press-release.update' , $data->id) }}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <a  class="w-50" target="_blank" href="{{ URL::asset('public/upload/admin/cmsfiles/pressRelease/')}}/{{$data->txtuplode}}" > View PDF</a>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xm-12">
                                    <div class="pull-right">
                                        ...
                                        <a href="{{URL::to('admin/press-release/')}}" class="btn btn-primary" >back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
