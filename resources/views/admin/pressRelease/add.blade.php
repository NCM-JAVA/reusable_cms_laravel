        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body"> 
                    ...
                    <form  action="{{URL::to('admin/press-release/')}}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        @csrf
                        ...
                        <div class="panel-body">
                            ...
                            <div id="txtDoc" style="display: none;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <textarea name="description" id="editor" class="form-control" rows="3" aria-hidden="true" ><?php echo old('description'); ?></textarea>
                                        </div>
                                            @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
