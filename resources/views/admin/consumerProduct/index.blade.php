        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 mb-2">
                    <a  style="float: right;" href="{{URL::to('admin/consumer-products/create')}}" class="btn btn-primary pull-right"> Add Consumer Product</a>
                </div> 
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="search-from mb-3">
                                <form action="{{ url('/admin/tender')}}" class="search_inbox" name="form1" id="form1" method="post" accept-charset="utf-8">
                                    @csrf
                                    <div class="form-row">
                                    ...
                                    <tbody id="list">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                <form action="{{ route('consumer-products.destroy',$row->id) }}"  method="POST"> 
                                                
                                                        <a class="btn btn-primary" href="{{ route('consumer-products.edit',$row->id) }}">Edit</a>
                                                        @csrf
                                                        @method('DELETE')
